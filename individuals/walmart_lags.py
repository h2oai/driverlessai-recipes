 ...
 """
    ...
    def set_genes(self):
        ...
        params = {'alpha': 0.05,
                  ...
                  'tgc': ['Date', 'Dept', 'Store'],
                  'time_column': ['Date']}
        self.add_transformer('EwmaLagsTransformer', col_type='time_column', gene_index=2, forced=False, mono=False, **params)
        ...
        params = {'datetime_formats': {'Date': '%Y-%m-%d'},
                  ...
                  'tgc': ['Date', 'Dept', 'Store'],
                  'time_column': ['Date']}
        self.add_transformer('LagsTransformer', col_type='time_column', gene_index=4, forced=False, mono=False, **params)
        ...
        params = {'aggregates': ['min',
                  ...
                  'n_jobs': 1,
                  'nan_value': nan,
                  'output_features_to_drop': ['6_LagsMin:Date:Dept:Store.IsHoliday.40:42:44:46:48:50:52:54:56:58:60:62:64'],
                  'pred_gap': 0,
                  'pred_periods': 39,
                  ...
                  'tgc': ['Date', 'Dept', 'Store'],
                  'time_column': ['Date']}
        self.add_transformer('LagsAggregatesTransformer', col_type='time_column', gene_index=6, forced=False, mono=False, **params)
