...
####################################################### MODULE SETUP #################################################################
# API Token
API_ACCESS_TOKEN = "eyJraWQiOiJrWUdtS1JpT3F0ZUFYc2tiK2lWUWVOM0tDTFRjQlhoNmpESEswYlFHMlEwPSIsImFsZyI6IlJTMjU2In0..NFFMRABChp5dC7sCYT7cAEP7gxGrmcsGuM34OA6uZjTLiNWDOV-fr7qGjT7nkl0OipuduK6pWDtJYg8pPyfdeuOJWc9s2KygZdt-bBP-t9gtsZz6gh0mLebsYT7XN-KlDbSNGFFSS2gyLfJS4m-4FOQtajUXRAHTsr_-gc60Tk1JghygD7mLejTqN-9rieddIopA89b_JSlul0lYr2uWFgkfMFcqiuBeVamT3LdEsJrbFI-8PaOLFJiAOvzXQQCNUL7NhpNdRdtqWunMdqOWkawg9jD7sflhc3ZlJfVfzjLOx8xFMpuJAqnXxaMl28AphsKfSKMQFpFcH35JSFd63Q"

# Snowflake Settings
SNOWFLAKE = {
    "url": "https://h20_ai_partner.snowflakecomputing.com",
    "username": "VIYENGAR",
    "password": "2307Leghorn",
    "database": "TEST_DB",
    "warehouse": "DEMO_WH",
    "schema": "PUBLIC",
    "role": "ACCOUNTADMIN"
...
class AugmentDataset(CustomData):
    ...
    def create_data(X: dt.Frame = None) -> Union[str, List[str],
        ...
        conn = APIConnector("http://data-augment-playground.h2o.ai/v1", API_ACCESS_TOKEN)
