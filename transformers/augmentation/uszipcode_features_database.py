    ...
    def get_zipcode_features(self, value):
        ...
        if (zip_data.zipcode_type == None):
            ...
            return {**result, 
                    ...
                    **self.to_dict_values(zip_dict, 'sources_of_household_income____percent_of_households_receiving_income'),
                    **self.to_dict_values(zip_dict, 'sources_of_household_income____average_income_per_household_by_income_source'),
                    **self.to_dict_values(zip_dict, 'household_investment_income____percent_of_households_receiving_investment_income'),
                    **self.to_dict_values(zip_dict, 'household_investment_income____average_income_per_household_by_income_source'),
                    **self.to_dict_values(zip_dict, 'household_retirement_income____percent_of_households_receiving_retirement_incom'),
                    **self.to_dict_values(zip_dict, 'household_retirement_income____average_income_per_household_by_income_source'),
