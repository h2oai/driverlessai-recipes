...
class NuSVCModel(CustomModel):
    ...
    _boosters = ['nusvc']
    _display_name = "NuSVC"
    _description = "Nu-SVC model based on sklearn. Not advised for large data"
    ...
    def predict(self, X, **kwargs):
        ...
        if not pred_contribs:
            ...
            raise NotImplementedError("No Shapley for Nu-SVC model")


class NuSVRModel(CustomModel):
    _regression = True
    _binary = False
    _multiclass = False
    ...
    _boosters = ['nusvr']
    _display_name = "NuSVR"
    _description = "Nu-SVR model based on sklearn. Not advised for large data"
    ...
    def predict(self, X, **kwargs):
        ...
        if not pred_contribs:
            ...
            raise NotImplementedError("No Shapley for Nu-SVR model")
