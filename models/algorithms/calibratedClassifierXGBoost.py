...
from h2oaicore.models import CustomModel, XGBoostModel
...
class CalibratedClassifierModel:
    ...
    _can_use_gpu = True
    _mojo = True
    _description = "Calibrated Classifier Model (XGBoost)"
...
class CalibratedClassifierXGBModel(CalibratedClassifierModel, XGBoostModel, CustomModel):
    _mojo = True
